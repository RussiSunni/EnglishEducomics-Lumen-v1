...
<div class="content">
    <div class="container">
        ...
        <div class="row mt-3">
            <div class="col-md-5">
                <img src="../../images/a-trip-to-victorian-england/present-simple-tense-04.png" class="img-fluid border border-dark rounded">
            </div>
            ...
            <div class="col-md-5">
                <img src="../../images/a-trip-to-victorian-england/present-simple-tense-05.png" class="img-fluid border border-dark rounded">
            </div>
        </div>
